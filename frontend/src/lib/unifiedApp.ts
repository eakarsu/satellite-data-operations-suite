...
const features = [
  {
    ...
    summary: 'Cases workflow normalized for the Satellite Data Operations suite with records, queues, approvals, audit, and reporting.',
    bullets: ['Cases queue', 'Approvals', 'Audit trail'],
    metrics: [{ label: 'Cases', value: '24', note: 'Active' }, { label: 'Exceptions', value: '3', note: 'Need review' }, { label: 'Due Soon', value: '5', note: 'Next 14 days' }],
  },
  {
    slug: 'incidents',
    title: 'Incidents',
    ...
    category: 'Public',
    icon: Users,
    summary: 'Incidents workflow normalized for the Satellite Data Operations suite with records, queues, approvals, audit, and reporting.',
    bullets: ['Incidents queue', 'Approvals', 'Audit trail'],
    metrics: [{ label: 'Incidents', value: '35', note: 'Active' }, { label: 'Exceptions', value: '4', note: 'Need review' }, { label: 'Due Soon', value: '6', note: 'Next 14 days' }],
  },
  {
    slug: 'units',
    title: 'Units',
    ...
    category: 'Public',
    icon: ClipboardList,
    summary: 'Units workflow normalized for the Satellite Data Operations suite with records, queues, approvals, audit, and reporting.',
    bullets: ['Units queue', 'Approvals', 'Audit trail'],
    metrics: [{ label: 'Units', value: '46', note: 'Active' }, { label: 'Exceptions', value: '5', note: 'Need review' }, { label: 'Due Soon', value: '7', note: 'Next 14 days' }],
  },
  {
    slug: 'schedules',
    title: 'Schedules',
    ...
    category: 'Public',
    icon: CalendarCheck,
    summary: 'Schedules workflow normalized for the Satellite Data Operations suite with records, queues, approvals, audit, and reporting.',
    bullets: ['Schedules queue', 'Approvals', 'Audit trail'],
    metrics: [{ label: 'Schedules', value: '57', note: 'Active' }, { label: 'Exceptions', value: '6', note: 'Need review' }, { label: 'Due Soon', value: '8', note: 'Next 14 days' }],
  },
  {
    slug: 'evidence',
    title: 'Evidence',
    ...
    category: 'Operations',
    icon: Activity,
    summary: 'Evidence workflow normalized for the Satellite Data Operations suite with records, queues, approvals, audit, and reporting.',
    bullets: ['Evidence queue', 'Approvals', 'Audit trail'],
    metrics: [{ label: 'Evidence', value: '68', note: 'Active' }, { label: 'Exceptions', value: '7', note: 'Need review' }, { label: 'Due Soon', value: '9', note: 'Next 14 days' }],
  },
  {
    slug: 'permits',
    title: 'Permits',
    ...
    category: 'Operations',
    icon: Workflow,
    summary: 'Permits workflow normalized for the Satellite Data Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: FileText,
    summary: 'Approvals workflow normalized for the Satellite Data Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: ShieldCheck,
    summary: 'Resources workflow normalized for the Satellite Data Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: BarChart3,
    summary: 'Compliance workflow normalized for the Satellite Data Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: PackageCheck,
    summary: 'Alerts workflow normalized for the Satellite Data Operations suite with records, queues, approvals, audit, and reporting.',
    bullets: ['Alerts queue', 'Approvals', 'Audit trail'],
    metrics: [{ label: 'Alerts', value: '123', note: 'Active' }, { label: 'Exceptions', value: '12', note: 'Need review' }, { label: 'Due Soon', value: '14', note: 'Next 14 days' }],
  },
  {
    slug: 'analytics',
    title: 'Analytics',
    ...
    icon: Bell,
    summary: 'Analytics workflow normalized for the Satellite Data Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Intelligence Layer',
    icon: Files,
    summary: 'Reports workflow normalized for the Satellite Data Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Files,
    summary: 'Satellite Data Operations documents, packets, evidence, attachments, and exports.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Bell,
    summary: 'Satellite Data Operations alerts, reminders, exceptions, and approvals.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Plug,
    summary: 'Satellite Data Operations source-system connector health and sync status.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: UserRound,
    summary: 'Satellite Data Operations users, roles, teams, permissions, and ownership settings.',
...
const aiFeatures = [
  {
    ...
    category: 'Intelligence Layer',
    icon: Bot,
    summary: 'Satellite Data Operations assistant for triage, summaries, drafting, recommendations, and operational review.',
...
export const featureFamilies = [
  { name: 'Public', features: ['Cases', 'Incidents', 'Units', 'Schedules'] },
  { name: 'Operations', features: ['Evidence', 'Permits', 'Approvals', 'Resources'] },
  { name: 'Governance', features: ['Compliance', 'Alerts'] },
...
export const featureContexts: Record<string, FeatureContext> = Object.fromEntries(
  allFeatures.map((feature) => [
    feature.title,
    {
      sourceOwners: ['AISatelliteDataOperationsAssistant', 'AISatelliteDataOperationsOperations where applicable'],
