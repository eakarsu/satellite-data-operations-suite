...
PORT="${PORT:-4950}"
DB_NAME="${PGDATABASE:-satellite_data_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Satellite Data Operations Suite"
echo "======================================="
echo
...
echo "Starting satellite data operations suite frontend on http://localhost:$PORT"
echo "Login: admin@satellite-data-operations.local / admin123"
